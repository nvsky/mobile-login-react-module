...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = __webpack_require__(161);
	...
	var Test = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { style: { margin: 0 } },
	      React.createElement(Login, { getCode: this.getCode,
	...
	var Login = React.createClass({
	  ...
	  checkCode: function checkCode() {
	    ...
	    if (this.refs.phoneValue.value && /^1\d{10}$/.test(this.refs.phoneValue.value)) {
	      (function () {
	        _this.refs.codeButton.setAttribute('disabled', 'true');
	        _this.refs.codeButton.style.opacity = 0.6;
	        _this.setState({
	          msg: ''
	        });
	        _this.props.getCode(_this.refs.phoneValue.value);
	        var num = 60;
	        var interval = setInterval(function () {
	          if (num > 0) {
	            ...
	            _this.refs.codeButton.style.opacity = 1;
	            _this.refs.codeButton.removeAttribute('disabled');
	            _this.setState({
	              codeButtonContent: '获取验证码'
	            });
	  ...
	  render: function render() {
	    ...
	    var seccondInput = classNames((_classNames = {}, _defineProperty(_classNames, prefixCls + '-input', true), _defineProperty(_classNames, prefixCls + '-bottom-none', true), _classNames));
	    return React.createElement(
	      'div',
	      restProps,
	      React.createElement(
